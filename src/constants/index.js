...
export const PROJECTS = [
  {
    ...
    image: project1,
    description:
      "Designed and implemented a blockchain-based DeFi staking application where users can approve tokens, stake tokens to earn rewards, and withdraw their tokens at any time. Built responsive design using ReactJS and Tailwind. Integrated blockchain functionalities ensuring seamless token transactions and reward management.",
    technologies: [
      "Solidity",
      "Web3.js/Ether.js",
      "ReactJS",
  ...
  },
  {
    ...
    image: project2,
    description:
      "Created a decentralized crowdfunding platform where users can launch and contribute to fundraising campaigns. Implemented smart contract to handle campaign creation, fund collection, and disbursement with transparency and security.",
    technologies: [
      "Solidity",
      "Web3.js/Ether.js",
      "ReactJS",
  ...
  {
    title: "BikeNGo",
    purpose: "Bikes renting app",
    image: project3,
    description:
      "Designed and implemented a decentralized bike rental platform enabling users to rent and manage bikes using blockchain technology. Integrated smart contracts to handle rental agreements, payments, and bike availability with transparency and security.",
    technologies: [
      "Solidity",
      "Web3.js/Ether.js",
      "ReactJS",
